...
\begin{figure}[t]
    ...
    \end{subfigure}
    \caption[Rauschspektra mit und ohne Rauschformung]{Rauschspektra mit und ohne Rauschformung. In grün wird dar Spektralbereich des Signals gezeigt. Der rote Graph zeigt das Quantisierungsrauschen. Der schattierte Bereich zeigt die Schnittmenge des Rauschens im Signal. $A$ und $B$ sind die Flächen unter dem roten Graphen, es gilt $A_1+B_1 \equiv A_2 + B_2$. Jedoch ist $A_2 < A_1$.}
